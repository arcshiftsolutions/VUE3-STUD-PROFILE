  ...
  <div class="status-card d-flex flex-wrap justify-space-between px-1 pb-2">
    <div class="py-0 pl-0">
        <q-card height="100%" width="100%" elevation=0>
            <div class="row">
                <div class="col" xl="auto" lg="auto" md="auto" sm="auto">
            ...
            <div class="row" v-if="showFirstSubmission">
                <div class="col" xl="auto" lg="auto" md="auto" sm="auto">
    ...
    <div class="pa-0 align-self-start" v-if="canCreateRequest(status)">
      <q-card height="100%" width="100%" elevation=0>
        <div justify="end" class="row pb-5">
          <q-btn color="#38598a" dark class="ml-2 text-none" @click.stop="$router.push({ path: 'request', append: true })">{{newRequestText}}</q-btn>
        </div>
      </q-card>
    </div>
