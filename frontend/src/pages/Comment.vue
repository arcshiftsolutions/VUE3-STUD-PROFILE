<template>
  <div class="comments">
    <div class="reply px-1">
      ...
      />
      <div class="row">
        <div class="col d-flex align-start flex-wrap py-0">
          <DocumentChip
        ...
        <div class="col d-flex flex-grow-0 justify-end py-0">
          <q-btn
            rounded
...
.theme--dark.q-btn.q-btn--disabled{
...
.v-textarea /deep/ .q-input__details {
  min-height: fit-content !important;
  margin-bottom: 0 !important;
}

.v-dialog > .q-card > .q-card__text {
