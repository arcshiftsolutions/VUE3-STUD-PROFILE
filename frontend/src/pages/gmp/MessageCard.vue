<template>
  ...
  <v-alert outlined height="100%" width="100%" class="pa-3 bootstrap-success" v-else-if="status === requestStatuses.AUTO || status === requestStatuses.MANUAL">
    ...
    <p class="mb-2">Below is the key information the Ministry of Education and Child Care has on file for you. If any of this information is not current, please proceed to <router-link to="ump">Update My PEN Info page</router-link>.</p>
    <q-page-container class="pen-info pt-0 pb-2 px-0 px-sm-3" justify="center">
      <div class="row py-0 px-2">
        <div class="col" xl="4" lg="4" md="4" sm="4">
          <p class="mb-2">Legal Last Name:</p>
        </div>
        <div class="col" xl="4" lg="5" md="5" sm="5">
